...
namespace MVC_Module.Controllers
{
    ...
    public class SecUserBorrowingReservationController : Controller
    {
        ...
        {
            ViewData["BllinkId"] = new SelectList(_context.BookLocationLinks, "Idbllink", "Idbllink");
        ...
        public async Task<IActionResult> Create([Bind("Idreservation,BllinkId,UserId,DateReserved,DateExpiration,DateBorrowed,DateReturned")] UserBorrowingReservation userBorrowingReservation)
        {
            ...
            {
                _context.Add(userBorrowingReservation);
