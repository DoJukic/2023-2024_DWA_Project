...
namespace MVC_Module.Controllers
{
    ...
    public class SecUserController : Controller
    {
        ...
        public SecUserController(DwaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Iduser,Name,MiddleNames,Surname")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Iduser,Name,MiddleNames,Surname")] User user)
        {
            if (id != user.Iduser)
            {
                return NotFound();
